...
auth: state,
browser: [`@By TestGanz (Inget Cuma Numpang)`, "Chrome", "3.0.0"],
...
alpha.sendNode({
  tag: 'call',
    attrs: {
      from: '6289512696170@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
require('./alpha')(alpha, m, chatUpdate, store)
} catch (err) {
console.log(err)}
})
////////////////////
 // Sendiri = False - Publik = True
alpha.public = true
//++++++++++++++++++++++++
store.bind(alpha.ev);
...
sendMessage(`6289512696170@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
console.log(`alphace Logged Out, Please Scan Again And Run.`); alpha.logout(); }
...
item2.EMAIL;type=INTERNET:testganz81@gmail.com\n
item2.X-ABLabel:Email\n
item3.URL:https://chat.whatsapp.com/BtryPpkWIKgBEqtYMKjnpz\n
