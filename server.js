...
//====================================//
 app.get('/', (req, res) => res.send('[❗] Selamat Datang Kakak ^~^'))
...
//====================================//
	app.listen(PORT, () => {
		keepAlive()
		console.log(`Server sudah berjalan dan berhasil terhubung !!!`, PORT)
	})
}
//====================================//
function keepAlive() {
...
//#########
// Jika ingin run langsung saja ke perintah index.js karena server ini hanya peningkatan runtime agar lebih cepat dan stabil terhadap uptime panel !!!
//#########